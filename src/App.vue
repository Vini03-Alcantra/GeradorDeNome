<template>
  <div>
    <div id="slogan" class="text-center">
      <h1>NomeGator</h1>
      <br />
      <h6 class="text-secondary">Gerador de nomes utilizando VueJS, NodeJS and GraphQL</h6>
    </div>
    <div id="main">
      <div class="container">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" v-model="prefix" v-on:keyup.enter="addPrefix(prefix)" placeholder="Write the the prefix">
          ...
          <div class="col-md">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <br/>
                  <div class="input-group">
                  <input type="text" class="form-control" v-model="sufix" v-on:keyup.enter="addPrefix(prefix)" placeholder="Write the the sufix">
                  <div class="input-group-append">
